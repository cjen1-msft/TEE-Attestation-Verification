...
//! Optional, backend-independent X.509 decoding. Cryptographic verification
//! remains with the selected backend; these types do not imply trust.
...
pub use x509_cert::der::oid::AssociatedOid;
pub use x509_cert::ext::pkix::name::GeneralName;
pub use x509_cert::ext::pkix::{ExtendedKeyUsage, KeyUsage, SubjectAltName};
pub use x509_cert::{der, ext};
