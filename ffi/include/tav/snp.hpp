...
public:
    ...
    {
        return tav_snp_attestation_report_version(handle_);
    }

    [[nodiscard]] uint32_t guest_svn() const
    {
        return tav_snp_attestation_report_guest_svn(handle_);
    }

    [[nodiscard]] uint64_t policy() const
    {
        return tav_snp_attestation_report_policy(handle_);
    }

    [[nodiscard]] uint8_t policy_abi_minor() const
    {
        return tav_snp_attestation_report_policy_abi_minor(handle_);
    }

    [[nodiscard]] uint8_t policy_abi_major() const
    {
        return tav_snp_attestation_report_policy_abi_major(handle_);
    }

    [[nodiscard]] bool policy_smt() const
    {
        return tav_snp_attestation_report_policy_smt(handle_);
    }

    [[nodiscard]] bool policy_migrate_ma() const
    {
        return tav_snp_attestation_report_policy_migrate_ma(handle_);
    }

    [[nodiscard]] bool policy_debug() const
    {
        return tav_snp_attestation_report_policy_debug(handle_);
    }

    [[nodiscard]] bool policy_single_socket() const
    {
        return tav_snp_attestation_report_policy_single_socket(handle_);
    }

    [[nodiscard]] bool policy_cxl_allow() const
    {
        return tav_snp_attestation_report_policy_cxl_allow(handle_);
    }

    [[nodiscard]] bool policy_mem_aes_256_xts() const
    {
        return tav_snp_attestation_report_policy_mem_aes_256_xts(handle_);
    }

    [[nodiscard]] bool policy_rapl_dis() const
    {
        return tav_snp_attestation_report_policy_rapl_dis(handle_);
    }

    [[nodiscard]] bool policy_ciphertext_hiding_dram() const
    {
        return tav_snp_attestation_report_policy_ciphertext_hiding_dram(handle_);
    }

    [[nodiscard]] bool policy_page_swap_disable() const
    {
        return tav_snp_attestation_report_policy_page_swap_disable(handle_);
    }

    [[nodiscard]] uint32_t vmpl() const
    {
        return tav_snp_attestation_report_vmpl(handle_);
    }

    [[nodiscard]] uint32_t signature_algo() const
    {
        return tav_snp_attestation_report_signature_algo(handle_);
    }

    [[nodiscard]] uint64_t platform_info() const
    {
        return tav_snp_attestation_report_platform_info(handle_);
    }

    [[nodiscard]] uint32_t flags() const
    {
        return tav_snp_attestation_report_flags(handle_);
    }

    [[nodiscard]] bool flags_author_key_en() const
    {
        return tav_snp_attestation_report_flags_author_key_en(handle_);
    }

    [[nodiscard]] bool flags_mask_chip_key() const
    {
        return tav_snp_attestation_report_flags_mask_chip_key(handle_);
    }

    [[nodiscard]] uint8_t flags_signing_key() const
    {
        return tav_snp_attestation_report_flags_signing_key(handle_);
    }

    [[nodiscard]] uint8_t cpuid_fam_id() const
    {
        return tav_snp_attestation_report_cpuid_fam_id(handle_);
    }

    [[nodiscard]] uint8_t cpuid_mod_id() const
    {
        return tav_snp_attestation_report_cpuid_mod_id(handle_);
    }

    [[nodiscard]] uint8_t cpuid_step() const
    {
        return tav_snp_attestation_report_cpuid_step(handle_);
    }

    [[nodiscard]] uint8_t current_build() const
    {
        return tav_snp_attestation_report_current_build(handle_);
    }

    [[nodiscard]] uint8_t current_minor() const
    {
        return tav_snp_attestation_report_current_minor(handle_);
    }

    [[nodiscard]] uint8_t current_major() const
    {
        return tav_snp_attestation_report_current_major(handle_);
    }

    [[nodiscard]] uint8_t committed_build() const
    {
        return tav_snp_attestation_report_committed_build(handle_);
    }

    [[nodiscard]] uint8_t committed_minor() const
    {
        return tav_snp_attestation_report_committed_minor(handle_);
    }

    [[nodiscard]] uint8_t committed_major() const
    {
        return tav_snp_attestation_report_committed_major(handle_);
    }
